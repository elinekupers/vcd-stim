function vcd_visualizeBackground(params, bckgrnd_im, save_dir, gaptype, borderwidth)
...
if params.store_imgs && isempty(save_dir)
    save_dir = fullfile(vcd_rootPath,'figs',params.disp.name,'background','visual_check');
