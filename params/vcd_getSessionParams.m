...
if load_params
    ...
    exp.session.mri.task_start                          = [1,1,1,1,1,8,8,1,1,1];    % LTM/IMG start at DEEP08 (the 9th session), everything else starts at DEEP01
    ...
    % MRI DEEP: Includes DEEP001 to DEEP029, DEEP30A and DEEP30B
    % there are 10x 6.05 min runs for DEEP sessions 1-30, session 30 has versions A and B
    exp.session.mri.deep.session_nrs                    = [1:46];           %#ok<*NBRAK> % Session nr, deep subject sampling
    exp.session.mri.deep.session_types                  = NaN(46,2);        % [Session nr,session type] 
    ...
    exp.session.mri.deep.n_runs_per_session             = NaN(46,2);       
    ...
    %% %%%% RUN %%%%
    % total run time is 237 TRs or 379.2 s
   ...
   % timing DEEP DEMO
    ...
    exp.run.min_run_dur_DEEP_DEMO  = exp.block.total_eyetracking_block_dur + exp.run.pre_blank_dur_DEEP_DEMO + exp.run.post_blank_dur_DEEP_DEMO;
    ...
    exp.run.actual_task_dur_DEEP_DEMO = exp.run.total_run_dur_DEEP_DEMO - exp.run.min_run_dur_DEEP_DEMO;
    ...
    % BEHAVIORAL DEMO RUNS HAVE HALF BLOCK SIZE, SO A SHORTER BLOCK DURATION
    ...
    % * Deep sessions 5-30 contain all crossings.
    % * Last deep session (30) has two session types (A and B).
    ...
    exp.session.mri.deep.add_catch_trials            = true;                 % Catch trials for deep MRI experiment
    ...
    exp.session.mri.wide.ses_blocks = zeros(size(exp.crossings,1),size(exp.crossings,2),length(exp.session.n_wide_sessions),2); % last dim represents session type
    exp.session.mri.deep.ses_blocks = zeros(size(exp.crossings,1),size(exp.crossings,2),length(exp.session.n_deep_sessions),2); % last dim represents session type
   ...
   exp.session.mri.demo.ses_blocks(:,:,8,2)   = exp.session.mri.demo.ses_blocks(:,:,5,1);
    ...
    exp.session.mri.deep.ses_blocks(:,:,2,1) = [	1	2	3	2	4	0	0	0	0	0	; ...
                                                    1	2	2	2	4	0	0	0	0	0	; ...
                                                    1	1	1	1	3	0	0	0	0	0	; ...
                                                    1	2	2	1	3	0	0	1	0	2	; ...
                                                    3	3	0	2	5	0	0	3	2	2	];
    ...
    exp.session.mri.deep.ses_blocks(:,:,5,1) = [	1	2	2	2	4	0	0	0	0	0	; ...
                                                    1	2	2	2	4	0	0	0	0	0	; ...
                                                    1	2	1	2	3	0	0	0	0	0	; ...
                                                    1	1	2	2	3	0	0	1	0	1	; ...
                                                    2	2	0	2	5	0	0	2	3	3	];

    exp.session.mri.deep.ses_blocks(:,:,6,1) = [	2	2	2	2	4	0	0	0	0	0	; ...
                                                    1	2	2	2	4	0	0	0	0	0	; ...
                                                    1	1	1	1	3	0	0	0	0	0	; ...
                                                    1	1	1	1	3	0	0	1	0	2	; ...
                                                    3	3	0	3	5	0	0	2	3	2	];

    exp.session.mri.deep.ses_blocks(:,:,7,1) = [	1	2	2	2	4	0	0	0	0	0	; ...
                                                    2	2	2	2	4	0	0	0	0	0	; ...
                                                    0	2	2	1	3	0	0	0	0	0	; ...
                                                    1	1	1	1	3	0	0	2	0	1	; ...
                                                    2	3	0	3	5	0	0	3	2	3	];

    exp.session.mri.deep.ses_blocks(:,:,8,1) = [	0	0	1	0	2	4	4	0	0	0	; ...
                                                    0	0	0	0	2	4	3	0	0	0	; ...
                                                    1	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	3	3	1	0	1	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];
    ...
    exp.session.mri.deep.ses_blocks(:,:,9,1) = [	0	1	0	1	1	4	3	0	0	0	; ...
                                                    1	0	0	0	2	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	1	; ...
                                                    0	1	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,10,1) =[	0	1	0	1	2	4	4	0	0	0	; ...
                                                    1	0	1	0	2	4	4	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	3	3	1	0	1	; ...
                                                    1	0	0	1	2	3	2	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,11,1) =[	1	0	0	1	2	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	4	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	1	1	0	1	3	3	0	0	1	; ...
                                                    0	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,12,1) =[	0	1	1	0	1	4	4	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    1	1	0	0	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	1	; ...
                                                    0	1	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,13,1) =[	0	0	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	1	2	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	3	0	0	0	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,14,1) =[	1	0	0	2	1	4	4	0	0	0	; ...
                                                    0	1	1	1	2	4	4	0	0	0	; ...
                                                    0	1	0	0	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	3	3	0	0	0	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,15,1) =[	0	1	1	1	2	4	3	0	0	0	; ...
                                                    0	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	0	1	3	4	0	0	0	; ...
                                                    1	0	0	1	1	4	3	0	0	1	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,16,1) =[	0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	1	1	2	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	3	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	1	; ...
                                                    1	1	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,17,1) =[	0	0	0	1	2	4	4	0	0	0	; ...
                                                    1	1	1	1	2	4	3	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	1	0	0	; ...
                                                    0	1	0	1	2	3	2	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,18,1) =[	0	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	1	2	4	3	0	0	0	; ...
                                                    0	1	1	1	1	4	4	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	1	; ...
                                                    1	0	0	1	2	3	2	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,19,1) =[	0	0	1	1	2	4	3	0	0	0	; ...
                                                    1	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	1	0	0	; ...
                                                    0	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,20,1) =[	0	1	1	1	1	4	4	0	0	0	; ...
                                                    0	1	0	1	2	4	4	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	0	; ...
                                                    0	0	0	0	1	3	3	1	0	1	; ...
                                                    1	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,21,1) =[	0	0	1	1	2	4	3	0	0	0	; ...
                                                    0	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	1	0	0	; ...
                                                    1	0	0	1	2	4	2	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,22,1) =[	1	0	1	1	2	4	4	0	0	0	; ...
                                                    0	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	0	1	3	3	0	0	0	; ...
                                                    0	1	0	0	1	3	4	0	0	1	; ...
                                                    0	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,23,1) =[	0	1	0	0	2	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	3	0	0	0	; ...
                                                    1	0	1	1	1	4	3	1	0	0	; ...
                                                    0	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,24,1) =[	1	0	0	1	1	4	3	0	0	0	; ...
                                                    0	1	1	1	2	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	4	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	1	; ...
                                                    0	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,25,1) =[	0	1	0	1	2	3	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	1	0	0	1	4	4	1	0	0	; ...
                                                    1	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,26,1) =[	0	0	0	1	2	4	3	0	0	0	; ...
                                                    1	1	0	1	2	3	3	0	0	0	; ...
                                                    0	1	0	0	2	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    1	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,27,1) =[	0	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	1	0	1	4	3	0	0	0	; ...
                                                    1	0	0	0	1	4	3	1	0	1	; ...
                                                    0	1	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,28,1) =[	0	0	0	1	2	4	4	0	0	0	; ...
                                                    0	1	1	0	1	4	3	0	0	0	; ...
                                                    1	0	0	1	1	3	3	0	0	0	; ...
                                                    0	1	1	0	1	4	4	0	0	1	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,29,1) =[	1	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	3	0	0	0	; ...
                                                    0	0	0	0	1	4	3	1	0	0	; ...
                                                    0	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,30,1) =[	0	0	0	0	2	4	3	0	0	0	; ...
                                                    1	1	1	1	2	3	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	4	0	0	0	; ...
                                                    0	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,31,1) =[	0	0	0	1	2	4	3	0	0	0	; ...
                                                    0	0	1	0	2	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	1	0	0	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,32,1) =[	0	1	1	1	2	3	3	0	0	0	; ...
                                                    0	0	0	1	2	4	4	0	0	0	; ...
                                                    1	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	1	0	0	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,33,1) =[	0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	0	1	0	1	4	3	0	0	0	; ...
                                                    0	1	0	0	1	4	3	0	0	0	; ...
                                                    1	0	0	1	1	4	4	1	0	1	; ...
                                                    0	1	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,34,1) =[	1	0	1	1	1	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	4	0	0	0	; ...
                                                    0	0	0	1	1	4	4	0	0	0	; ...
                                                    0	1	0	0	1	4	3	0	0	1	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,35,1) =[	0	1	0	1	2	4	3	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	1	0	0	1	4	3	1	0	0	; ...
                                                    1	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,36,1) =[	0	0	1	1	1	4	3	0	0	0	; ...
                                                    1	1	0	1	2	3	4	0	0	0	; ...
                                                    0	0	0	1	1	4	4	0	0	0	; ...
                                                    0	0	0	1	1	4	3	0	0	0	; ...
                                                    0	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,37,1) =[	0	0	0	0	2	4	2	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    1	1	0	1	1	4	4	0	0	0	; ...
                                                    0	0	1	0	1	4	3	1	0	0	; ...
                                                    1	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,38,1) =[	0	1	0	1	1	4	3	0	0	0	; ...
                                                    0	0	0	1	2	4	2	0	0	0	; ...
                                                    0	0	0	0	1	4	4	0	0	0	; ...
                                                    1	1	0	1	1	4	4	0	0	0	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,39,1) =[	1	0	1	1	1	4	3	0	0	0	; ...
                                                    1	1	0	1	2	4	4	0	0	0	; ...
                                                    0	0	1	0	1	4	3	0	0	0	; ...
                                                    0	0	0	0	1	4	3	0	0	1	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,40,1) =[	0	1	0	1	1	4	3	0	0	0	; ...
                                                    0	0	1	1	2	4	3	0	0	0	; ...
                                                    0	0	0	0	1	3	3	0	0	0	; ...
                                                    0	0	0	1	1	4	4	1	0	0	; ...
                                                    1	1	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,41,1) =[	0	1	1	1	1	3	4	0	0	0	; ...
                                                    0	0	0	1	1	3	4	0	0	0	; ...
                                                    0	0	0	0	1	3	3	0	0	0	; ...
                                                    0	0	1	0	2	4	4	1	0	1	; ...
                                                    1	0	0	1	2	4	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,42,1) =[	0	0	1	0	1	3	4	0	0	0	; ...
                                                    0	1	0	1	1	3	4	0	0	0	; ...
                                                    1	0	1	1	1	4	4	0	0	0	; ...
                                                    0	1	0	0	1	4	4	0	0	1	; ...
                                                    0	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,43,1) =[	0	0	1	0	2	4	3	0	0	0	; ...
                                                    0	0	0	1	2	3	3	0	0	0	; ...
                                                    0	1	0	0	1	3	4	0	0	0	; ...
                                                    0	0	1	1	1	4	4	1	0	0	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,44,1) =[	1	1	0	0	1	3	4	0	0	0	; ...
                                                    0	0	1	0	1	4	4	0	0	0	; ...
                                                    0	0	1	0	1	4	4	0	0	0	; ...
                                                    0	1	1	0	1	3	3	0	0	1	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,45,1) =[	0	0	1	0	1	3	4	0	0	0	; ...
                                                    0	0	1	1	1	4	3	0	0	0	; ...
                                                    0	0	1	0	1	3	4	0	0	0	; ...
                                                    1	1	1	0	1	4	4	1	0	0	; ...
                                                    1	0	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,46,1) =[	0	0	1	0	2	4	3	0	0	0	; ...
                                                    0	0	1	0	1	4	4	0	0	0	; ...
                                                    0	0	1	0	1	4	3	0	0	0	; ...
                                                    0	0	1	0	1	4	3	1	0	1	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];

    exp.session.mri.deep.ses_blocks(:,:,46,2) =[	0	0	0	0	2	4	3	0	0	0	; ...
                                                    0	0	0	0	1	4	4	0	0	0	; ...
                                                    0	1	0	1	1	4	3	0	0	0	; ...
                                                    0	1	0	1	1	4	3	1	0	1	; ...
                                                    1	1	0	1	2	3	3	1	1	1	];
    ...
    nr_repeats                            = [0.5    1   1   1   1    4/3    2/3   1   1   1; ...
                                             0.5    1   1   1   1    4/3    2/3   1   1   1; ...
                                             0.5    1   1   1   1    4/2    2/2   1   1   1;...
                                             0.5    1   1   1   1    4/2    2/2   1   1   1;...
                                               1    1   0   1   1   28/30  14/30  1   1   1]; 
    exp.nr_unique_trials_per_crossing    = exp.nr_unique_trials_per_crossing .* nr_repeats;
    
    % Only for deep MRI (1 catch trial per unique cycle for NS and FIX/LTM/IMG tasks)
    exp.nr_unique_catch_trial_per_repeats = [ 1   2   2   2   2   1   1   0   0   0; ...
                                              1   2   2   2   2   1   1   0   0   0; ...
                                              1   2   2   2   2   1   1   0   0   0; ...
                                              1   2   2   2   2   1   1   2   0   2; ...
                                              1   1   0   1   0   1   1   1   1   1];
    % how many times do we want a task classes to be repeated relate to other task classes
    exp.repeat_ratios                    =  [0.5  0.5   0.5   1   1   2   2   1   1   1];                                     
    ...
    % nr of blocks for each experiment 
    exp.nr_blocks_wide                   = sum(sum(exp.session.mri.wide.ses_blocks,3),4);
    exp.nr_blocks_deep                   = sum(sum(exp.session.mri.deep.ses_blocks,3),4);
    exp.nr_blocks_MRI                    = exp.nr_blocks_wide+exp.nr_blocks_deep;

    % nr of unique condition repeats
    exp.n_unique_trial_repeats_wide     = ceil( (exp.nr_blocks_wide.*exp.nr_trials_per_block) ./  exp.nr_unique_trials_per_crossing); % round up because we create single cycle first and then shave off trials due to mismatch between nr of unique trials and trials/block.
    exp.n_unique_trial_repeats_deep     = ceil( (exp.nr_blocks_deep.*exp.nr_trials_per_block) ./  exp.nr_unique_trials_per_crossing);
    exp.n_unique_trial_repeats_mri      = ceil( (exp.nr_blocks_MRI.*exp.nr_trials_per_block) ./  exp.nr_unique_trials_per_crossing);
    ...
    if exp.session.mri.wide.add_catch_trials
        exp.nr_catch_trials_wide         = ceil(exp.nr_unique_catch_trial_per_repeats .* ((exp.nr_blocks_wide.*exp.nr_trials_per_block) ./  exp.nr_unique_trials_per_crossing) .* exp.repeat_ratios);
    else
        exp.nr_catch_trials_wide         = zeros(5, 10);
    end
    
    if exp.session.mri.deep.add_catch_trials
        exp.nr_catch_trials_deep         = ceil(exp.nr_unique_catch_trial_per_repeats .* ((exp.nr_blocks_deep.*exp.nr_trials_per_block) ./  exp.nr_unique_trials_per_crossing) .* exp.repeat_ratios);
    else
        exp.nr_catch_trials_deep         = zeros(5, 10);
    end
    
    
    % nr of trials for MRI
    exp.nr_trials_wide                  = (exp.nr_blocks_wide .* exp.nr_trials_per_block) + exp.nr_catch_trials_wide;
    exp.nr_trials_deep                  = (exp.nr_blocks_deep .* exp.nr_trials_per_block) + exp.nr_catch_trials_deep;
    exp.nr_trials_mri                   = exp.nr_trials_wide + exp.nr_trials_deep;
