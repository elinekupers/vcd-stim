    ...
    switch run_frames.frame_event_nr(framecnt)
        ...
        case {94, 95} % stim IDs
            ...
            elseif length(sides) == 2  % Make and draw two stimulus textures
                ...
                Screen('DrawTextures',win,stim_textures',[], catcell(1,stim.rects(run_frames.im_IDs(framecnt,1),:))', zeros(length(stim_textures),1),[], ones(length(stim_textures),1), 255*ones(length(stim_textures),3)');
